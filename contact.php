...
<head>
	...
	<title><?php echo $translations['contact']; ?> – Gacik Aleksandar</title>
										...
										<div class="pbmit-ihbox-heading-with-icon">
											<div class="pbmit-ihbox-icon ">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-gimox-business-icon pbmit-gimox-business-icon-placeholder-1"></i>
												</div>
											</div>
								...
								<div class="pbmit-ihbox-style-1">
									<div class="pbmit-ihbox-inner">
										<div class="pbmit-ihbox-heading-with-icon">
											<div class="pbmit-ihbox-icon ">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-gimox-business-icon pbmit-gimox-business-icon-phone-call"></i>
												</div>
											</div>
											<div class="pbmit-ihbox-heading">
												<div class="pbmit-vc_general pbmit-vc_cta3">
								...
								<div class="pbmit-ihbox-style-1">
									<div class="pbmit-ihbox-inner">
										<div class="pbmit-ihbox-heading-with-icon">
											<div class="pbmit-ihbox-icon ">
												<div class="pbmit-ihbox-icon-wrapper">
													<i class="pbmit-gimox-business-icon pbmit-gimox-business-icon-mail"></i>
												</div>
											</div>
											<div class="pbmit-ihbox-heading">
												<div class="pbmit-vc_general pbmit-vc_cta3">
