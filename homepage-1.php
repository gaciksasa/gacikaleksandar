   ...
   <body>
	...
	<div class="page-wrapper">
		...
		<header class="site-header header-style-1">
			...
			<!-- START Home Slider 1 REVOLUTION SLIDER 6.5.19 --><p class="rs-p-wp-fix"></p>
...
<!--
							...
							><span class="pbmit-skincolor">THE Best </span>Fitness<br>
Studio in Town  
							</rs-layer><!--
...
-->						</rs-slide>
		...
		<div class="page-content">
			...
			<section class="section-md">
				<div class="container">
					<div class="pbmit-heading-subheading text-center">
						<h4 class="pbmit-subtitle">CLASSES TIMETABLE</h4>
						<h2 class="pbmit-title">Weekly Classes Schedule</h2>
					</div>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">BootCamp</a>
											<p>Adrian Holmes</p>
										</div>
									</td>
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Krunch & Kore</a>
									...
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Total Body</a>
											<p>David Richards</p>
										</div>
									</td>
									<td></td>
									...
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Energy Blast</a>
											<p>Marion Miller</p>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Crossfit</a>
											<p>Logan Park</p>
										</div>
									</td>
									<td></td>
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Boxercise</a>
											<p>Jesse Willis</p>
										</div>
									</td>
									<td></td>
									<td>
										<div class="mptt-inner-event-content">
											<a href="#" class="event-title">Spinning</a>
											<p>Lela Rhodes</p>
										</div>
									</td>
									<td>
					...
					<div class="mptt-shortcode-list">
						<div class="mptt-column">
							...
							<ul class="mptt-events-list">
								<li class="mptt-list-event" data-event-id="bootcamp">
									<a title="BootCamp" href="#" class="mptt-event-title"> BootCamp	</a>
									<p class="event-subtitle">Adrian Holmes</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="crossfit">
									<a title="Crossfit" href="#" class="mptt-event-title">Crossfit</a>
									<p class="event-subtitle">Logan Park</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="total-body">
									<a title="Total Body" href="#" class="mptt-event-title">Total Body</a>
									<p class="event-subtitle">David Richards</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="boxercise">
									<a title="Boxercise" href="#" class="mptt-event-title">Boxercise</a>
									<p class="event-subtitle">Jesse Willis</p>
									<p class="event-description"></p>
								</li>
							</ul>
						</div>
						<div class="mptt-column">
							...
							<ul class="mptt-events-list">
								<li class="mptt-list-event" data-event-id="krunch-kore">
									<a title="Krunch &amp; Kore" href="#" class="mptt-event-title">Krunch &amp; Kore</a>
									<p class="event-subtitle">Katharine Barnes</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="spinning">
									<a title="Spinning" href="#" class="mptt-event-title">Spinning</a>
									<p class="event-subtitle">Lela Rhodes</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="krunch-kore">
									<a title="Krunch &amp; Kore" href="#" class="mptt-event-title">Krunch &amp; Kore</a>
						...
						<div class="mptt-column">
							...
							<ul class="mptt-events-list">
								...
								<li class="mptt-list-event" data-event-id="energy-blast">
									<a title="Energy Blast" href="#" class="mptt-event-title">Energy Blast</a>
									<p class="event-subtitle">Marion Miller</p>
									<p class="event-description"></p>
								</li>
								<li class="mptt-list-event" data-event-id="crossfit">
									<a title="Crossfit" href="#" class="mptt-event-title">Crossfit</a>
							...
							<div class="testimonial-one-box">
								<div class="swiper-slider" data-loop="true"  data-autoplay="true" data-dots="true" data-arrows="false"  data-columns="1" data-margin="30" data-effect="slide">
									<div class="swiper-wrapper">
										<div class="swiper-slide">                           
											<!-- Slide1 -->
											<article class="pbmit-testimonialbox-style-1">
												<div class="pbmit-post-item">
													<div class="pbmit-box-content">
														<div class="pbmit-box-author">
															...
															<div class="pbmit-box-author-top">
																<div class="pbmit-box-title">Henry Walker</div>
																<span class="pbmit-testimonial-designation">Expert</span>				
															</div>
														</div>
														<div class="pbmit-box-desc">
															<blockquote class="pbmit-testimonial-text">
																<div class="pbmit-testimonial-textbox">
																	Fitness Gym isn’t anything like a regular chain gym. The gym also has amazing equipment that you don’t find in most gyms like Kettlebells, challeng battle ropes and sledges.	
																</div>
															</blockquote>
														</div>
														<div class="pbmit-box-author-bottom">
													...
													<div class="pbmit-box-content">
														<div class="pbmit-box-author">
															<div class="pbmit-box-img">
																<span class="pbmit-item-thumbnail">
																	<span class="pbmit-item-thumbnail-inner">
																		<img src="images/homepage-1/testimonail/testimonial-02.jpg" class="img-fluid" alt="">
																	</span>
																</span>
															</div>
															<div class="pbmit-box-author-top">
																<div class="pbmit-box-title">Jesmin Narayon</div>
																<span class="pbmit-testimonial-designation">Journalist</span>				
															</div>
														</div>
														<div class="pbmit-box-desc">
															<blockquote class="pbmit-testimonial-text">
													...
													<div class="pbmit-box-content">
														<div class="pbmit-box-author">
															<div class="pbmit-box-img">
																<span class="pbmit-item-thumbnail">
																	<span class="pbmit-item-thumbnail-inner">
																		<img src="images/homepage-1/testimonail/testimonial-03.jpg" class="img-fluid" alt="">
																	</span>
																</span>
															</div>
															<div class="pbmit-box-author-top">
																<div class="pbmit-box-title">Allien John</div>
																<span class="pbmit-testimonial-designation">Customer</span>				
															</div>
														</div>
														<div class="pbmit-box-desc">
															<blockquote class="pbmit-testimonial-text">
            ...
            <section class="section-md team-section-one">
				<div class="container"> 
					<div class="pbmit-heading-subheading text-center">
						<h4 class="pbmit-subtitle">OUR STRONGEST TEAM</h4>
						<h2 class="pbmit-title">MEET EXPERT TRAINERS</h2>
						<div class="pbmit-content-wrapper">
							<p>Train with the best experts in bodybuilding field. Your results will speak. Try latest exercising trends, innovative and special Training plans.</p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-4 col-sm-6">
							<article class="pbmit-teambox-style-1">
								<div class="pbmit-post-item">
									...
									<div class="pbmit-box-content">
										...
										<div class="pbmit-box-title">
											<h2 class="pbmit-title">
												<a href="trainer-details.html">David Smith</a>
											</h2>
										</div>
									</div>
									<div class="pbmit-teambox-social-links">
										<div class="pbmit-team-social-links-wrapper">
											<ul class="pbmit-team-social-links">
												<li>
													<a href="#" target="_blank" class="pbmit-team-social-facebook">
														<i class="pbmit-base-icon-facebook"></i>
														<span class="pbmit-hide">Facebook</span>
													</a>
												</li>
												<li>
													<a href="#" target="_blank" class="pbmit-team-social-twitter">
														<i class="pbmit-base-icon-twitter"></i>
														<span class="pbmit-hide">Twitter</span>
													</a>
												</li>
												<li>
													<a href="#" target="_blank" class="pbmit-team-social-google">
														<i class="pbmit-base-icon-gplus"></i>
														<span class="pbmit-hide">Google+</span>
													</a>
												</li>
												<li>
													<a href="#" target="_blank" class="pbmit-team-social-linkedin">
														<i class="pbmit-base-icon-linkedin"></i>
														<span class="pbmit-hide">LinkedIn</span>
													</a>
												</li>
											</ul>
										</div>		
							...
							<article class="pbmit-teambox-style-1">
								<div class="pbmit-post-item">
									<div class="pbmit-team-image-box">
										<span class="pbmit-item-thumbnail">
											<span class="pbmit-item-thumbnail-inner">
												<img src="images/homepage-1/team/team-02.jpg" class="img-fluid" alt="">
											</span>
										</span>		
									</div>
									<div class="pbmit-box-content">
										...
										<div class="pbmit-box-title">
											<h2 class="pbmit-title">
												<a href="trainer-details.html">William Dixon</a>
											</h2>
										</div>
									</div>
									<div class="pbmit-teambox-social-links">
							...
							<article class="pbmit-teambox-style-1">
								<div class="pbmit-post-item">
									<div class="pbmit-team-image-box">
										<span class="pbmit-item-thumbnail">
											<span class="pbmit-item-thumbnail-inner">
												<img src="images/homepage-1/team/team-03.jpg" class="img-fluid" alt="">
											</span>
										</span>		
									</div>
									<div class="pbmit-box-content">
										...
										<div class="pbmit-box-title">
											<h2 class="pbmit-title">
												<a href="trainer-details.html">Amara Mcguire</a>
											</h2>
										</div>
									</div>
									<div class="pbmit-teambox-social-links">
            ...
            <!-- Team End -->
           	...
           	<!-- Client Start --> 
			<section class="section-md pbmit-bg-color-blackish client-section-one">
				<div class="container"> 
					<div class="row g-0">
						<div class="col-md-12 col-lg-3">
							<div class="client-one-titlebox pbmit-bg-skincolor">
								<div class="pbmit-heading-subheading text-white">
									<h4 class="pbmit-subtitle">our clients</h4>
									<h2 class="pbmit-title">a few of our clients</h2>
								</div>
								<a href="index.html" class="pbmit-btn pbmit-btn-white mb-0">
									<span>View all</span>
								</a>
							</div>
						</div>
						<div class="col-md-12 col-lg-9">
							<div class="client-one-box">
								<div class="row g-0">
									<div class="col-lg-3 col-sm-6">
										<div class="pbmit-client-logo-tooltip" data-tooltip="client 08">
									...
									<div class="col-lg-3 col-sm-6">
										<div class="pbmit-client-logo-tooltip" data-tooltip="client 07">
											<div class="pbmit-clientbox-style-1">
												<span class="pbmit-item-thumbnail">
													<span class="pbmit-item-thumbnail-inner">
									...
									<div class="col-lg-3 col-sm-6">
										<div class="pbmit-client-logo-tooltip" data-tooltip="client 02">
											<div class="pbmit-clientbox-style-1">
												<span class="pbmit-item-thumbnail">
													<span class="pbmit-item-thumbnail-inner">
														<img src="images/homepage-1/client/client-07.png" class="img-fluid" alt="">
													</span>
												</span>	
											</div>
										</div>
									...
									<div class="col-lg-3 col-sm-6">
										<div class="pbmit-client-logo-tooltip" data-tooltip="client 01">
											<div class="pbmit-clientbox-style-1">
												<span class="pbmit-item-thumbnail">
													<span class="pbmit-item-thumbnail-inner">
														<img src="images/homepage-1/client/client-08.png" class="img-fluid" alt="">
													</span>
												</span>	
											</div>
										</div>
