...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Insert new service
  $sql = "INSERT INTO services (title, icon, description, image, link) VALUES (?, ?, ?, ?, ?)";
  $stmt = $conn->prepare($sql);
  $stmt->bind_param("sssss", $title, $icon, $description, $target_file, $link);
  $stmt->execute();
  $stmt->close();
  $conn->close();
...
<head>
  ...
  <title>Add Service - Gacik Aleksandar</title>
